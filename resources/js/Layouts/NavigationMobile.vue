          ...
          <button @click="showingTwoLevelMenu = !showingTwoLevelMenu"
            ...
            <ul v-show="showingTwoLevelMenu || route().current('books.index') || route().current('books.create')" class="p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium text-gray-500 rounded-md shadow-inner bg-gray-50"
              ...
              <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
                <ResponsiveNavLink class="w-full" :href="route('books.index')" :active="route().current('books.index')" >
                   List
                </ResponsiveNavLink>
              </li>
              <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800">
                <ResponsiveNavLink class="w-full" :href="route('books.index')" :active="route().current('books.create')" >
                   Create
                </ResponsiveNavLink>
              </li>
            </ul>
