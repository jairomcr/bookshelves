...
const shoModalView = ref(false);
const shoModalForm = ref(false);
const shoModalDel = ref(false);
const title = ref("");
const opertation = ref(1);
const msj = ref(1);
...
const openModalView = (a) => {
    ...
    shoModalView.value = true;
};
const openModalForm = (op,a) => {
    shoModalForm.value = true;
    opertation.value = op;
    if (op === 1) {
...
const openModalDel = (a) => {
    shoModalDel.value = true;
    v.value.id = a.id;
    v.value.name = a.last_name+' '+a.name;
};
const closeModalView = () => {
    shoModalView.value = false;
};
const closeModalForm = () => {
    shoModalForm.value = false;
    form.reset();
};
const closeModalDel = () => {
    shoModalDel.value = false;
};
const save = () => {
    if (opertation.value == 1) {
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="inline-flex overflow-hidden mb-4 w-full bg-white rounded-lg shadow-md" :class="clasMsj">
        ...
        <Modal :show="shoModalView" @close="closeModalView">
            <div class="p-6">
                <p>
                    Author:
        ...
        <Modal :show="shoModalForm" @close="closeModalForm">
            <div class="p-6">
        ...
        <Modal :show="shoModalDel" @close="closeModalDel">
            <div class="p-6">
